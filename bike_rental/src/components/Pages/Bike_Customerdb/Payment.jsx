...
//   Swal.fire('Payment Successfully!', 'Your action submit ', 'success');
// }
const Payment = () => {
      ...
      <div className="col-md-6 p-2">
            ...
            <form className="row g-3 mb-3">
              <div className="col-12">
                ...
                <input type="email" value={email} onChange={e => emailchange(e.target.value)} className="form-control" id="inputEmail4" required />
              </div>
              <div className="col-12">
              ...
              <div className="col-md-6">
                ...
                <input type="text" value={city} onChange={e => citychange(e.target.value)} className="form-control" id="inputCity" />
              </div>
              ...
              <div className="col-md-2">
                ...
                <input type="text" value={zip} onChange={e => zipchange(e.target.value)} className="form-control" id="inputZip" />
              </div>
