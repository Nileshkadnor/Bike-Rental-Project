...
const Customerform = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const custobj = { custname, dob, qty, rate, amt: amount, status };
...
return (
<>    
<div style={{backgroundColor: '#8abde9'}}>
           ...
           <div className="col-lg-6 offset-lg-3">
              ...
              <h3 className="text-center">Customer Form</h3>
                 ...
                 <div className="form-group">
                    ...
                    <input type="text"value={custname} onChange={e => custnamechange(e.target.value)} className="form-control" required></input>
                  </div> 
                  <div className="form-group">
                ...
                {/* {data.map(data => (
                 ...
                 <input value= {bikerh}onChange={e => bikerhchange(e.target.value)} disabled="disabled" className="form-control" required></input> */}
                  ...
                  <div className="form-group">
                        ...
                        <button onClick={handleSucessClick} className="btn btn-success" type="submit">Submit</button>
